          ...
          <div className='w-full'>
            ...
            <div>
              ...
              <div className="w-[95%] bg-gray-200 rounded-full dark:bg-gray-700 mb-2">
                <div className="bg-green-600  text-lg pt-1 h-8 font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" style={{ width: `${completionPercentage.toFixed(2)}%` }}>
