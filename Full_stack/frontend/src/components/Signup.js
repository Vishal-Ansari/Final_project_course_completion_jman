...
export default function Signup() {
    ...
    return (
        loading ? <LoadingUi /> : (
            ...
            >
                <form
                    className="login-form w-md mx-auto bg-white p-8 rounded-lg shadow-md w-96"
                    onSubmit={handleCreateAccount}
                >
                    <h2 className="text-center mb-2 text-xl font-bold">Registration Form</h2>
                    <div className="mb-5">
                        <label
                            htmlFor="name"
                    ...
                    <p className=" cursor-pointer text-center " >
                        Already an user? <Link onClick={handleLoginClick} className="text-[#e11d48] hover:underline">Login</Link>
                    </p>
                </form>
            </div>
        )
